...
public class DBHelper extends SQLiteOpenHelper
{
	...
	{
		Cursor c = getReadableDatabase().query("entries", null, "category=?", new String[]{"schools"}, null, null, "position");
	...
	{
		Cursor c = getReadableDatabase().query("entries", null, "category=?", new String[]{"experience"}, null, null, "position");
	...
	{
		Cursor c = getReadableDatabase().query("entries", null, "category=?", new String[]{"additional"}, null, null, "position");
	...
	{
		Cursor c = getReadableDatabase().query("entries", null, "category=?", new String[]{"languages"}, null, null, "position");
	...
	{
		Cursor c = getReadableDatabase().query("entries", null, "category=?", new String[]{"hobby"}, null, null, "position");
	...
	private void initDB()
	{
		...
		cv.put("header", "");
		cv.put("content", "praca z relacyjnymi bazami danych\nznajomość systemu kontroli wersji Git\nznajomość systemu operacyjnego Linux");
		getWritableDatabase().insert("entries", null, cv);
